...
Original Text: https://mycrypto.groovehq.com/knowledge_base/topics/words-are-hard-defining-common-terms-in-the-ethereum-slash-crypto-space
...
* Ejemplo: MyCrypto.com, tu billetera Ledger, un contrato de billetera Multisig.
...
* [MyCrypto Knowledge Base Article on the Subject (WIP, too)](http://mycrypto.groovehq.com/knowledge_base/topics/what-is-the-difference-between-an-exchange-eg-coinbase-kraken-gemini-poloniex-bittrex-and-mycrypto)


#### Gas (Gas Limit vs Gas Price)
* https://mycrypto.groovehq.com/knowledge_base/topics/what-is-gas
