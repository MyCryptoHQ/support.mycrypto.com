...
*   When adding a [custom token](https://support.mycrypto.com/send/adding-new-token-and-sending-custom-tokens.html):
...
*   Remove and [re-add the custom token](https://support.mycrypto.com/send/adding-new-token-and-sending-custom-tokens.html).
